...
-- First, let's add some sample sales with various products

-- Sample Sale 1: Large tire purchase
...
(2, 759.96, 60.80, 0.00, 'cash', 800.00, 40.04, datetime('now', '-2 days', '+8 hours'));

-- Get the sale ID for the items
-- Sale 1 items: 4 Michelin Defender T+H tires
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(1, 1, 4, 189.99, 759.96);

-- Update stock for the products sold
...
-- Sale 3 items: Brake pads + Air filter
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(3, 15, 1, 45.99, 45.99),
(3, 20, 1, 12.99, 12.99),
(3, 19, 1, 49.99, 49.99);
...
-- Sample Sale 4: Performance tire upgrade
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 1199.96, 96.00, 50.00, 'card', 1199.96, 0.00, datetime('now', '-3 days', '+16 hours'));

-- Sale 4 items: 4 Pirelli P Zero tires
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
...
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 67.96, 5.44, 0.00, 'cash', 70.00, 2.04, datetime('now', '-4 days', '+12 hours'));

-- Sale 5 items: Car care bundle
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(5, 29, 1, 14.99, 14.99),
(5, 30, 1, 24.99, 24.99),
(5, 31, 1, 8.99, 8.99),
...
-- Sample Sale 6: Truck tire replacement
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 799.96, 64.00, 0.00, 'card', 799.96, 0.00, datetime('now', '-5 days', '+9 hours'));

-- Sale 6 items: 4 Goodyear Wrangler tires
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(6, 3, 4, 199.99, 799.96);
...
-- Sample Sale 7: Winter tire preparation
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 719.96, 57.60, 20.00, 'cash', 750.00, 30.04, datetime('now', '-6 days', '+15 hours'));

-- Sale 7 items: 4 Dunlop Winter tires
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(7, 6, 4, 179.99, 719.96);
...
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 89.95, 7.20, 0.00, 'card', 89.95, 0.00, datetime('now', '-7 days', '+11 hours'));

-- Sale 8 items: Various fluids and filters
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(8, 8, 1, 18.99, 18.99),
(8, 9, 1, 28.99, 28.99),
(8, 12, 1, 12.99, 12.99),
...
-- Sample Sale 9: Wheel upgrade
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 999.96, 80.00, 100.00, 'card', 999.96, 0.00, datetime('now', '-8 days', '+13 hours'));

-- Sale 9 items: 4 American Racing wheels
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
...
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 89.96, 7.20, 0.00, 'cash', 90.00, 0.04, datetime('now', '-9 days', '+17 hours'));

-- Sale 10 items: Various accessories
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(10, 25, 1, 29.99, 29.99),
(10, 27, 1, 19.99, 19.99),
(10, 28, 1, 24.99, 24.99),
...
-- Add some sales from different days to show trends
-- Sample Sale 11: Today's sale
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 165.99, 13.28, 0.00, 'card', 165.99, 0.00, datetime('now', '+2 hours'));

-- Sale 11 items: Bridgestone tire
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
...
-- Sample Sale 13: High-value sale
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 1499.96, 120.00, 200.00, 'card', 1499.96, 0.00, datetime('now', '-10 days', '+14 hours'));

-- Sale 13 items: 4 Fuel wheels
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
...
-- Sample Sale 14: Small sale
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 24.99, 2.00, 0.00, 'cash', 25.00, 0.01, datetime('now', '-11 days', '+16 hours'));

-- Sale 14 items: Single product
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(14, 30, 1, 24.99, 24.99);
...
-- Sample Sale 15: Multiple items sale
INSERT INTO sales (cashier_id, total_amount, tax_amount, discount_amount, payment_method, payment_received, change_given, created_at) VALUES
(2, 156.95, 12.56, 10.00, 'card', 156.95, 0.00, datetime('now', '-12 days', '+10 hours'));

-- Sale 15 items: Multiple products
INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, total_price) VALUES
(15, 16, 1, 52.99, 52.99),
(15, 17, 1, 68.99, 68.99),
(15, 18, 1, 39.99, 39.99);
